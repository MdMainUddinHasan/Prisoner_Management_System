...
<div class="page-content">
	...
	<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
		<div class="breadcrumb-title pe-3" style="border:none">Visitor Registration</div>
		<div class="ms-auto">
			<div class="btn-group">
        ...
        <div class="modal-content bg-dark">
            ...
            <div class="modal-body">
            	<div class="border p-4 rounded">
						...
						<div class="row mb-3">
							<label for="inputEnterYourName" class="col-sm-3 col-form-label">Relation With Prisoner</label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="inputEnterYourName" placeholder="Enter Relation With Prisoner">
							</div>
						</div>
						
						<div class="row mb-3">
							<label for="inputEnterYourName" class="col-sm-3 col-form-label">Visitor Full Name</label>
							<div class="col-sm-9">
