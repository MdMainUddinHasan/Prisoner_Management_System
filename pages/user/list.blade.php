				...
				<table id="example2" class="table table-striped table-bordered">
					...
					<tbody>
						<tr>
							...
							<td>Male</td>
							<td>
								<button type="button" class="btn btn-light" title="Edit" style="padding:20px 10px 10px 10px" data-bs-toggle="modal" data-bs-target="#examplePrimaryModal" onclick="add()"><i class="bx bx-comment-detail me-0"></i></button>

								<button type="button" class="btn btn-light" title="Booked" style="padding:20px 10px 10px 10px"><i class="fadeIn animated bx bx-trash"></i></button>
							</td>
						</tr>
						<tr>
							<td>2</td>
